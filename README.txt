OV-Pay Balance shows the balance and status of your OV-pay card. Works for any OV-pay card, using the card number and sequence number printed on the card.
...
What makes OV-Pay Balance different? You can add multiple cards — each as its own tile in Homey with separate notifications and automations. Perfect when everyone in the family has their own card, or when you want to keep an eye on the kids' travel credit.
